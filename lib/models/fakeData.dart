...
Map homePagePosterMap={
  "Image Assets" : Assets.images.test1.path,
  "Writer":"Melika Azizi",
  "Time":"1 Day Ago",
...
List <Hashtag> tagList = [
  Hashtag(title: "Java"),
  Hashtag(title: "Web programming"),
  Hashtag(title: "Podcast"),
  Hashtag(title: "Dart"),
  Hashtag(title: "Political"),
  Hashtag(title: "Basketball")
];
...
طبق گزارش‌های منتشر شده، ماسک در مجموع پنج فرم 4 را به کمیسیون بورس و اوراق بهادار ایالات متحده (SEC) ارائه کرده که تمام 138 تراکنش فردی او را پوشش می‌دهد. بر اساس محاسبات TechCrunch، ارزش سهام فروخته شده، نزدیک به 4 میلیارد دلار است. به گزارش رویترز، این میزان معادل 2.6 درصد از سهام او در تسلا محسوب می‌شود
  ...
  BlogModel(
      ...
      title:
          "Apple's second quarter 2022 fiscal year earnings report has been published; 9% revenue growth",
      writer: "Javad Taji",
...
هرچند اپل همچنان با محدودیت‌های عرضه دست و پنجه نرم می‌کند، اما در گزارش درآمد سه ماهه دوم سال مالی خود، بهترین فصل منتهی به مارس را در تاریخش گزارش کرد. غول فناوری در این سه ماهه، 97.3 میلیارد دلار درآمد داشته که نسبت به مدت زمان مشابه در سال گذشته، 9 درصد افزایش یافته است. همچنین سود این شرکت 25 میلیارد دلار و سود هر سهم آن 1.52 دلار بوده است.
  ...
  BlogModel(
      ...
      title: "How do Red Planet explorers generate electricity on Mars?",
      writer: "Marzieh Farji",
      writerImageUrl:
...
«آنتونی آبل» محقق دپارتمان مهندسی شیمی دانشگاه «برکلی» و یکی از نویسندگان این مطالعه می‌گوید: «برای تولید برق در مریخ، موقعیت کاوشگر در سطح سیاره عامل تعیین کننده است. اگر به خط استوا نزدیک باشد، استفاده از انرژی خورشیدی توصیه می‌شود و اگر به قطب‌ها نزدیک باشد، بهتر است از انرژی هسته‌ای استفاده شود.»
  ...
  BlogModel(
      ...
      title: "How does love affect the functioning of our brain?",
      writer: "Marzieh Farji",
      writerImageUrl:
          "https://digiato.com/wp-content/uploads/2022/02/10897985_639437109516078_4342420382567329691_n-300x300.jpg",
      date: "۱۷ ساعت پیش",
...
List <PodcastModel> podcastList = [
  PodcastModel(
    id: 1,
    imageUrl:"https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQRh-1t5hlnDaosmexwECOzPGNEVBP_OGt6oZ1cjO2U91HSpao" ,
    title: "Hondelatte Tells - Christophe Hondelatte",
    speaker: "Europe 1",
    writerImageUrl: "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQRh-1t5hlnDaosmexwECOzPGNEVBP_OGt6oZ1cjO2U91HSpao",
    date: "13 hours ago",
    content: "",
    views: "69"),
    ...
    PodcastModel(
      id: 2,
    imageUrl: "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcT1231dFryaCCfAeasrMa_FHcGSZXRB2fHFCJlVj8nGO62QDVA",
    title: "After Football",
    speaker: "RMC",
    writerImageUrl: "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcT1231dFryaCCfAeasrMa_FHcGSZXRB2fHFCJlVj8nGO62QDVA",
    date: "18 hours ago",
    content: "",
    views: "51"),
    ...
    PodcastModel(
    id: 3,
    imageUrl: "https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcS6tzIchij3trz8bZi0SBSicLVRCBYsruBxamcBUz_kto4yrA4",
    title: "Laurent Gerra",
    speaker: "RTL",
    writerImageUrl: "https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcS6tzIchij3trz8bZi0SBSicLVRCBYsruBxamcBUz_kto4yrA4",
    date: "4 hours ago",
    content: "",
    views: "33"),
    ...
    PodcastModel(
    id: 4,
    imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXm7xxTLTigRDvc09kd8kfbjUR70omV1_ePJgSScLrmLaMlaf8",
    title: "The Big Mouths",
    speaker: "RMC",
    writerImageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXm7xxTLTigRDvc09kd8kfbjUR70omV1_ePJgSScLrmLaMlaf8",
    date: "7 hours ago",
    content: "",
    views: "60"),
    ...
    PodcastModel(
    id: 5,
    imageUrl: "https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcTBrUMtL1giS2-DVpGG4M3ow-JxLzDqPsiIwv3hO2welyyCw-U",
    title: "Franck Ferrand tells...",
    speaker: "Classical Radio",
    writerImageUrl: "https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcTBrUMtL1giS2-DVpGG4M3ow-JxLzDqPsiIwv3hO2welyyCw-U",
    date: "5 hours ago",
    content: "",
    views: "52"),
